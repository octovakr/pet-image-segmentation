...
_train_idx, _val_idx = random_split(range(total_size), [train_size, val_size])

train_set = _TransformDataset(_full_raw, _train_idx, make_train_transforms())
val_set   = _TransformDataset(_full_raw, _val_idx,   make_val_transforms())
